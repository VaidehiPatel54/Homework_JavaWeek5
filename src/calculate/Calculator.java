...
public class Calculator {
    ...
    //instance methods
    void addition(int a, int b){        //No return type method with parameters

        System.out.println(a+b);
    }
    void subtraction(int a, int b){     //No return type method with parameters

        System.out.println(a-b);
    }
    void division(int a, int b){        //No return type method with parameters

        System.out.println(a/b);
    }
    void multiplication(int a, int b){      //No return type method with parameters

        System.out.println(a*b);
    }
    void calculateResult(int a, int b ,char symbol){    //No return type method with parameters

        //Nested if else
        if(symbol == '+')
        {
            System.out.println("Addition of " + a + " and " + b + " is : " + (a + b));      //Output print statement
        }
        else if(symbol == '-')
        {
            System.out.println("Subtraction of " + a + " and " + b + " is : " + (a - b));   //Output print statement

        }
        else if(symbol == '/')
        {
            System.out.println("Division of " + a + " and " + b + " is : " + a / b);       //Output print statement
        }
        else if(symbol == '*')
        {

            System.out.println("Multiplication of " + a + " and " + b + " is : " + a * b);      //Output print statement
        }
        else
        {
